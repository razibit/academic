...
export default function TeachingPage() { const items = getCollection<MaterialMeta>("teaching"); return <main className="main-content"><h1>Teaching</h1><Markdown content={getMarkdownPage("teaching").body} /><AcademicCollection asSection title="Teaching materials" items={items} emptyMessage="Teaching entries will be added as individual content files." /></main>; }
